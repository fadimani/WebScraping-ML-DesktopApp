...
public class ClassificationTask {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //!     Loading the data
        DataSource source = new DataSource("C:\\Users\\imani\\OneDrive\\Bureau\\machineLearning\\src\\main\\java\\org\\example\\data\\zoo.arff");
        Instances data = source.getDataSet();
        System.out.println(data.numInstances() + " instances loaded."); // number of instances loaded
        // System.out.println(data.toString());

        // remove animal attribute from the training set cus it's what we wanna predict
        ...
        //!     Feature selection
        // we don't wanna use all the features, too much overfitting. we wanna use the most informative of them
        // so we rank em and see
        ...
        //this is a ranked list of the most informative features
        System.out.println("Selected attributes: "+Utils.arrayToString(indices));
        //  12,3,7,2,0,1,8,9,13,4,11,5,15,10,6,14,16
        //?The top three most informative attributes are 12 (fins), 3 (eggs), 7 (aquatic), 2 (hair),
        //and so on. Based on this list, we can remove additional, non-informative features in order to help learning algorithms achieve more accurate and faster learning models.

        //!     Build a decision tree
        String[] options = new String[1];
        options[0] = "-U";
        J48 tree = new J48();           //using the J48 algorithm
        tree.setOptions(options);       // passing option -U: unpruned tree
        tree.buildClassifier(data);     // initialize the learning process and storing it in tree
